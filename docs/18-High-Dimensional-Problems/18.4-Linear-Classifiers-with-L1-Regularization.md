...
总共有 16898 个 $m/z$，取值从 $2000$ 到 $40,000$．完整数据集包含 157 个健康的病人和 167 个癌症患者，并且目标是寻找 $m/z$ 的位点来在两个群中间进行判别．这是函数型数据的例子，预测变量可以看成是 $m/z$ 的一个函数．在最近今年里这个问题引起很大的研究兴趣，见 Petricoin et al. (2002)[^11]．
